...
function loadLanguageEN(){
  ...
  data = 
  {
    "contactPresentation": "Senior Software Engineer",
    "WETitleGeneral": "Work Experience",
    ...
    "C": [
      {
        "CTitle10": "Freelance",
        "CTime10": "2016 May - 2016 Dec",
        "CSubtitle10": "Web-Designer / Development",
        "CDescription10": "- Java - backend<br> - Web-Page Development<br>"      
      },
      {
        "CTitle9": "cm3p Gmbh",
        "CTime9": "2015 Oct - 2016 Apr",
        "CSubtitle9": "<strong>Master Thesis: Integration from OpenCV in the Smartphone platforms, IPhone, IPad and Android</strong>",
        "CDescription9": "<strong>C++, OpenCV:</strong> Designed an image comparison app using SIFT and SURF, proprietary algorithms "      
      },
      {
        "CTitle8": "Hochschule Mannheim",
        "CTime8": "2015 Feb - 2015 Jun",
        "CSubtitle8": "<strong>Steinbeis - Hiwi, Lab Assistant</strong>",
        "CDescription": "<strong>C++, OpenCV: </strong>Digital image processing."      
      },
      {
        "CTitle7": "Freelance",
        "CTime7": "2011 Oct - 2012 May",
        "CSubtitle7": "<strong>Software Developer</strong>",
        "CDescription7": "<strong>Webrageous.com</strong><br>- PHP, jquery scripts<br><strong>Software Sales and Development</strong><br>- PHP, jquery scripts, Websites testing, Drupal, Wordpress.<br><strong>Others</strong><br>- Testing Applications and set-up of Content Delivery Network "      
      },
      {
        "CTitle6": "Pontificia Universidad Javeriana",
        "CTime6": "2006 Jun - 2006 Oct",
        "CSubtitle6": "<strong>Web - Development</strong>",
        "CDescription6": "- Software tools development for the XI Symposium in Image Processing, <br>Signals and Artificial Vision<br>- Web Programming in PHP and MYSQL, Openconf "      
      }
    ]
...
function loadLanguageDE(){
  ...
  data = 
  {
    "contactPresentation": "Senior Software Ingenieur",
    "WETitleGeneral": "Berufserfahrung",
    ...
    "WE": [
      {
        "WETitle5": "CTO  -  Mercury Cash",
        "WETime5": "2022 Jul - aktuell",
        "WEDescription5": "Wiederaufbau der IT-Abteilung, Stabilisierung der Produktionsumgebung und strategische Planung<br> <strong>Verwaltung der Abteilung:</strong>- Projektplanung und Erstellung von Leistungsmetriken.<br> - Festlegung interner Sicherheitsrichtlinien, Umgang mit Sicherheitsnachweisen und <br><span class='spacer1'>&nbsp;</span> Dokumentenverwaltung<br> - Festlegung von Verfahren für die Einstellung von Ressourcen<br> <strong>Migration in die Cloud:</strong> - Migration der Digital Ocean-Plattform zu AWS <br> - Ersetzen von Kernteilen des Systems durch neue Microservices-orientierte <br><span class='spacer1'>&nbsp;</span> Implementierungen. <br> <strong>Personalwesen:</strong> - Umstrukturierung der IT-Abteilung und Aufbau eines stabilen Teams von 6 Mitgliedern. <br> <strong>Anbieter:</strong> - Überprüfung der bestehenden IT-Dienstleister, Neuverhandlung der bestehenden Verträge"
           
      },
      {
        "WETitle4": "Senior Fullstack Entwickler  -  Ad & Vision",
        "WETime4":  "2021 Feb - 2022 Mai",
        "WEDescription4": "Technische Leitung und DevOps für Webentwicklungsprojekte Webentwicklung<br><strong>Web:</strong> - Planung und Entwicklung strategischer Webprojekte für Kunden wie Ferrero<br> - Entwicklung interner Verwaltungstools<br> <strong>DevOps:</strong> - Planung der Cloud-Infrastruktur mit Ionos, AWS und onPremises<br> - Aufbau von CI/CD-Pipelines für mehrere Projekte."      
      },      
      {
        "WETitle3": "Senior Software Ingenieur  -  cm3p GmbH",
        "WETime3": "2017 Feb - 2021 Jan",
        "WEDescription3": "Technische Leitung und Programmierung des SDK für Messgeräte von Leica Geosystems<br> <strong>Android:</strong> - Verbindung, Senden und Empfangen von Daten von Messgeräten über Bluetooth und Wifi-Netzwerke. <br> - Aktualisierung der App von Bihl+Wiedemann auf die neuesten Android SDK-<br><span class='spacer1'>&nbsp;</span>Versionen<br> <strong>iOS:</strong> - SDK-Implementierung und Client-Support. <br> - Aktualisierung der App von Bihl+Wiedemann auf die neuesten iOS SDK-Versionen<br> <strong>Swift:</strong> - Plattformübergreifendes, auf Computer Vision basierendes Automatisierungs-framework. iOS Vision Library, Vapor-Backend, OpenCV."      
      }, 
      {
    ...
    "S": [
      {
        "STitle10": "Hochschule Mannheim",
        "STime10": "2014 - 2016",
        "SSubtitle10": "Master in InformationsTechnik",
        "SDescription10": "- Artificial Vision<br>- Embedded Systems<br>- Biomedical<br>Thesis: Integration von OpenCV in die Smartphone-Plattformen, IPhone, IPad und Android"      
      },
      {
        "STitle9": "EUDE Business School",
        "STime9": "2015 - 2016",
        "SSubtitle9": "M.B.A",
        "SDescription9": "Master in Business Administration, M.B.A"      
      },
      {
...
function loadLanguageES(){
  ...
  data = 
  {
    "contactPresentation": "Ingeniero Software Senior",
    "WETitleGeneral": "Experiencia laboral",
    ...
    "C": [
      {
        "CTitle10": "Freelance",
        "CTime10": "2016 May - 2016 Dec",
        "CSubtitle10": "Web - Diseño / Desarrollo",
        "CDescription10": "- Java - backend<br> - Desarrollo Web<br>"      
      }
    ]
...
function loadData(){
  ...
  document.querySelector("#SK100").innerText = data.SK100
  document.querySelector("#SK101").innerText = data.SK101
  document.querySelector("#SK102").innerText = data.SK102
  document.querySelector("#SK103").innerText = data.SK103
  ...
  document.querySelector("#WETitle5").innerText = data.WE[0].WETitle5
  document.querySelector("#WETime5").innerText = data.WE[0].WETime5
  document.querySelector("#WEDescription5").innerHTML = data.WE[0].WEDescription5

  document.querySelector("#WETitle4").innerText = data.WE[1].WETitle4
  document.querySelector("#WETime4").innerText = data.WE[1].WETime4
  document.querySelector("#WEDescription4").innerHTML = data.WE[1].WEDescription4


  document.querySelector("#WETitle3").innerText = data.WE[2].WETitle3
  document.querySelector("#WETime3").innerText = data.WE[2].WETime3
  document.querySelector("#WEDescription3").innerHTML = data.WE[2].WEDescription3


  document.querySelector("#WETitle2").innerText = data.WE[3].WETitle2
  document.querySelector("#WETime2").innerText = data.WE[3].WETime2
  document.querySelector("#WEDescription2").innerHTML = data.WE[3].WEDescription2


  document.querySelector("#WETitle1").innerText = data.WE[4].WETitle1
  document.querySelector("#WETime1").innerText = data.WE[4].WETime1
  document.querySelector("#WEDescription1").innerHTML = data.WE[4].WEDescription1


  document.querySelector("#WETitle0").innerText = data.WE[5].WETitle0
  document.querySelector("#WETime0").innerText = data.WE[5].WETime0
  document.querySelector("#WEDescription0").innerHTML = data.WE[5].WEDescription0
